...
const Pricing = () => {
    ...
    return (
        <div className="relative flex flex-col items-center justify-center max-w-6xl px-4 py-16 sm:px-6 lg:px-12 lg:py-24 mx-auto">
            <div className="flex flex-col items-center justify-center max-w-2xl mx-auto">
                <Container>
                    <div className="flex flex-col items-center text-center max-w-2xl mx-auto px-2 sm:px-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 pt-10 lg:pt-12 gap-6 max-w-4xl mx-auto px-2 sm:px-4 w-full">
                {PLANS.map((plan, idx) => (
...
const Plan = ({ plan, billPlan }: { plan: PLAN; billPlan: Plan }) => {
    return (
        ...
        >
            ...
            <div className="flex flex-col items-start w-full p-5 md:px-8 gap-y-2">
